...
import CountrySearch from "./CountryPaginatedSearch";
...
export default function PersistentDrawerLeft(props: PersistentDrawerProps) {
    ...
    // {/*TODO: potentially get rid of container height since we're not using react-infinite anymore*/}
    const { windowHeight, windowWidth } = useWindowDimensions();

    return (
        <Box sx={{ display: 'flex' }}>
            <CssBaseline />
            <AppBar position="fixed" open={open} color="transparent" elevation={0} sx={{
                pointerEvents: "none",
                // TODO: confirm whether this below chunk is necessary
                "& > *": {
                    "& > *": {
                        pointerEvents: "auto",
                    }
